...
exports.registerMovement = void 0;
...
const registerMovement = async (input, userId) => {
    ...
    try {
        ...
        const movement = await Movement_model_1.default.create({
            product: productId,
            type,
            quantity,
            unitPrice,
        ...
        await Kardex_model_1.default.create({
            product: productId,
